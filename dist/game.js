...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  var handleError = /* @__PURE__ */ __name((error, reject) => {
  ...
  var _getRequestParams = /* @__PURE__ */ __name((method, options, body) => {
  ...
  __name(isSecureEnvironment, "isSecureEnvironment");
  ...
  __name(getCookieString, "getCookieString");
  ...
  __name(uuid, "uuid");
  var isBrowser2 = /* @__PURE__ */ __name(() => typeof window !== "undefined", "isBrowser");
  ...
  __name(getParameterByName, "getParameterByName");
  ...
  __name(PostgrestBuilder, "PostgrestBuilder");
  ...
  __name(PostgrestTransformBuilder, "PostgrestTransformBuilder");
  ...
  __name(PostgrestFilterBuilder, "PostgrestFilterBuilder");
  ...
  __name(PostgrestQueryBuilder, "PostgrestQueryBuilder");
  ...
  __name(PostgrestRpcBuilder, "PostgrestRpcBuilder");
  ...
  __name(PostgrestClient, "PostgrestClient");
  ...
  __name(RealtimeSubscription, "RealtimeSubscription");
  ...
  var RealtimeClient = class {
    ...
    onConnMessage(rawMessage) {
      this.decode(rawMessage.data, (msg) => {
        ...
        this.channels.filter((channel2) => channel2.isMember(topic)).forEach((channel2) => channel2.trigger(event, payload, ref));
    ...
    setAuth(token) {
      ...
      try {
        this.channels.forEach((channel2) => {
          token && channel2.updateJoinPayload({ user_token: token });
          if (channel2.joinedOnce && channel2.isJoined()) {
            channel2.push(CHANNEL_EVENTS.access_token, { access_token: token });
          }
        });
      } catch (error) {
    ...
    _triggerChanError() {
      this.channels.forEach((channel2) => channel2.trigger(CHANNEL_EVENTS.error));
    }
  ...
  var SupabaseRealtimeClient = class {
    constructor(socket2, headers, schema, tableName) {
      const chanParams = {};
      ...
      this.subscription = socket2.channel(topic, chanParams);
    }
  ...
  __name(SupabaseRealtimeClient, "SupabaseRealtimeClient");
  ...
  __name(SupabaseQueryBuilder, "SupabaseQueryBuilder");
  ...
  var handleError2 = /* @__PURE__ */ __name((error, reject) => {
    if (typeof error.json !== "function") {
      return reject(error);
    }
    error.json().then((err) => {
  ...
  __name(SupabaseStorageClient, "SupabaseStorageClient");
  ...
  // code/main.js
  var supaUrl = "https://jfjboqfvzmvqoxueioco.supabase.co";
  var supaAnonKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpmamJvcWZ2em12cW94dWVpb2NvIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NDQ2MDQ3NzMsImV4cCI6MTk2MDE4MDc3M30.T5iwAaBZkzwFmU-l8cqlPVrwJy5wSLTL8EiAHD6dnDQ";
  var supa = createClient(supaUrl, supaAnonKey);
  var socket = new RealtimeClient("wss://multiplayer-demo.fly.dev/socket", {
    params: { apikey: supaAnonKey }
  });
  socket.connect();
  var channel = socket.channel("multiplayer:pos");
  channel.subscribe();
  no({
    logMax: 1
  });
  ...
  var playerStream = supa.from("players").on("*", (payload) => {
    const data = payload.new;
    const dbPlayer = players[data.id];
    if (!dbPlayer || dbPlayer.playerId === (player == null ? void 0 : player.playerId))
      return;
